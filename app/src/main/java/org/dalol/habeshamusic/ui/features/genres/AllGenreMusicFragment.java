...
import org.dalol.habeshamusic.ui.extras.GridItemsMarginDecorator;
 ...
 */
public class AllGenreMusicFragment extends BaseChildFragment {

    private final static int SPAN_COUNT = 2;

    public static AllGenreMusicFragment newInstance() {

        Bundle args = new Bundle();

        AllGenreMusicFragment fragment = new AllGenreMusicFragment();
    ...
    protected void bindView(View view) {
        ...
        RecyclerView genreList = view.findViewById(R.id.list_genres);
        genreList.setHasFixedSize(true);
//        genreList.setLayoutManager(new GridLayoutManager(context, SPAN_COUNT));
...
//        imageSources.add("http://www.huluzefen.com/assets/images/genres/Instrumental.jpg");
    ...
    private class MusicDashboardAdapter extends RecyclerView.Adapter<MusicDashboardAdapter.MusicDashboardViewHolder> {
        ...
        class MusicDashboardViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                addChildFragment(AllGenreMusicFragment.newInstance(), "TAG_GENRE_MUSIC");
            }
        }
    }
}
